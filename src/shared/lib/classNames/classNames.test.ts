...
describe('classNames', () => {
  ...
  test('С модами и дополнительным массивом параметров', () => {
    ...
    expect(
      classNames('class1', { class4: true, class5: true }, ['class2', 'class3'])
    ).toBe(expected);
  });
  ...
  test('С модами и дополнительным массивом параметров (один из модов false)', () => {
    ...
    expect(
      classNames('class1', { class4: false, class5: true }, [
        'class2',
        'class3'
      ])
    ).toBe(expected);
  ...
  test('С модами и дополнительным массивом параметров (один из модов undefined)', () => {
    ...
    expect(
      classNames('class1', { class4: false, class5: true, class6: undefined }, [
        'class2',
        'class3'
      ])
    ).toBe(expected);
